      ...
      case "right":
        if (numberOfRepetitions === 0) {
          ...
          switch (numberOfRepetitions) {
            case 1:
              calulcatedBlocksAway.north = calulcatedBlocksAway.north - Number(directions[i + 1]);
              break;
            case 2:
                calulcatedBlocksAway.east = calulcatedBlocksAway.east - Number(directions[i + 1]);
              break;
            case 3:
